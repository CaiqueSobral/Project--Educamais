package com.educamais.controller.response.Exceptions;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> emailAlreadyInUse(IdAlreadyRegisteredException e, HttpServletRequest request){
